...
- name: AWS Identity and Access Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/files/master/_listings/aws-identity-and-access-management/action-listinstanceprofilesforrole-get.md
x-common:
- type: x-change-log
