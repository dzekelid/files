...
- name: Azure Traffic Manager API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/files/master/_listings/azure-traffic-manager/subscriptions-subscriptionid-providers-microsoft-network-trafficmanagerprofiles-get.md
x-common:
