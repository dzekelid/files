...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/files/master/_listings/swagger/apis.md
...
- name: Swagger Generator - Downloads a pre-generated file
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/files/master/_listings/swagger/gendownloadfileid-get-openapi.md
- name: Swagger Generator - Downloads a pre-generated file
  x-api-slug: gendownloadfileid-get
  description: A valid `fileId` is generated by the `/clients/{language}` or `/servers/{language}`
    POST operations.  The fileId code can be used just once, after which a new `fileId`
