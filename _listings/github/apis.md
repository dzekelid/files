...
- name: Github
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/files/master/_listings/github/repos-owner-repo-pulls-number-files-get.md
- name: Github Get Repos Owner Repo Pulls Number Files
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/files/master/_listings/github/repos-owner-repo-pulls-number-files-get-postman.md
x-common:
- type: x-net-library
