...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/files/master/_listings/dezrez/apis.md
specificationVersion: "0.14"
apis:
- name: Dezrez.Rezi.Client.Api - Get files and details that can be used to customize
    a website
  x-api-slug: apibrandingwebsitesetupbrandid-get
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/files/master/_listings/dezrez/apibrandingwebsitesetupbrandid-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/files/master/_listings/dezrez/apibrandingwebsitesetupbrandid-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Updates the filename of an existing document.
  x-api-slug: apidocumentrename-put
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/files/master/_listings/dezrez/apidocumentrename-put-openapi.md
- name: Dezrez.Rezi.Client.Api - Updates the filename of an existing document.
  x-api-slug: apidocumentrename-put
  description: Updates the filename of an existing document..
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28888-www-dezrez-com.jpg
